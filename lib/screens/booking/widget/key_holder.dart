  ...
  Future<void> fetchKeyHolders() async {
    ...
    try {
      ...
      if (docSnapshot.exists && docSnapshot.data() != null) {
        ...
        setState(() {
          bayNumbers = availableBays.isNotEmpty ? availableBays : [];
          selectedBay = bayNumbers.contains(selectedBay) ? selectedBay : null; // Ensure valid selection
        });
      } else {
        setState(() {
          bayNumbers = [];
        ...
        children: [
          ...
          Container(
            ...
            child: DropdownButton<String>(
              ...
              isExpanded: true,
              hint: bayNumbers.isEmpty ?const Text("No Available Key Holder", style: TextStyle(color: whiteColor)) :  const Text("Choose Your Key Holder", style: TextStyle(color: whiteColor)), // ✅ Hint added
              ...
              items: bayNumbers.isNotEmpty
                  ? bayNumbers.map<DropdownMenuItem<String>>((String value) {
